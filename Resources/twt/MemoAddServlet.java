...
*/
        String memo_text = request.getParameter("memo_inputText");
        ...
        memoDAO.insertMemo();
        out.println("<script>alert('"+ memoDAO.qur +"');</script>");
        out.println(memo_text);
        out.println(memoDAO.team_id);
        out.println(memoDAO.text);
        out.println(memoDAO.posX);
        out.println(memoDAO.posY);
